...
import NetworkService, { IConfigRequest } from '@Network/interfaces/networkService';
...
export default class NetworkAxiosService implements NetworkService {
    ...
    _request = (url: string, method: string, data: any, config: IConfigRequest = {}) => {
    ...
    delete(url: string, body: any, config: IConfigRequest) {
        return this._request(url, 'DELETE', body, config);
    }

    get(url: string, config?: IConfigRequest) {
        return this._request(url, 'GET', null, config);
    }

    patch(url: string, body: any, config?: IConfigRequest) {
        return this._request(url, 'PATCH', body, config);
    }

    post(url: string, body: any, config?: IConfigRequest) {
        return this._request(url, 'POST', body, config);
    }

    put(url: string, body: any, config?: IConfigRequest) {
